...
Source code not changed, simply make this project under the control of 
autotools.  This will make the package more easily compiled on different
machines. Hope this simple modification can make the software more widely
available.
